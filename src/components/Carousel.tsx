...
const CarouselHome = () => {
  return (
    <div
      className="flex-grow flex flex-col md:flex-row lg:space-x-6 gap-16 
     items-center justify-center px-4 md:px-24 py-16 bg-amber-50 text-lighter-green-3"
    >
      <div className="w-full max-w-lg md:max-w-xl   max-md:order-2">
        <p className="text-3xl max-md:text-center text-gray-800 font-semibold">
          Features
        </p>
