      ...
      >
        ...
        <div className="lg:w-full">
          ...
          <ul className="text-gray-600 w-full max-sm:mt-8">
            <li
              className="bg-yellow-50 py-2 mx-2 rounded-xl shadow-lg my-2 
                hover:bg-darker-turquoise hover:text-black "
            >
              {WorkingData.steps[0]}
            </li>
            <li
              className="bg-yellow-100 py-2 mx-2 rounded-xl shadow-lg my-2 
                 hover:bg-darker-turquoise hover:text-black"
            >
              {WorkingData.steps[1]}
            </li>
            ...
            <li
              className="bg-yellow-200 py-2 mx-2 rounded-xl shadow-lg my-2
                 hover:bg-darker-turquoise hover:text-black "
            >
              {WorkingData.steps[4]}
            </li>
