...
const HeroSection = () => {
  ...
  return (
    <div className="w-full h-full bg-amber-100 text-gray-800">
      <div className="flex flex-col justify-center ">
        ...
        <div className="flex justify-evenly items-center mt-6 bg-amber-50 pb-20">
          {session ? (
            <div className="flex flex-col justify-center items-center mt-8 gap-4">
              <div className="text-center gap-4">
                ...
                <p className="max-w-[900px] text-s font-light">
                  You are all set to receive anonymous feedback. Click below to
                  access your dashboard, generate new links, and manage your
                  messages.
                </p>
              </div>
              <div>
