...
const Page = () => {
  ...
  return (
    <div className=" flex justify-center items-center flex-col  bg-amber-50 h-full lg:flex-row lg:px-40 min-h-screen">
      ...
      <div className="lg:w-full">
        ...
        <div className="mt-4">
          ...
          <Link href="sign-in">
            <Button
              type="submit"
              className="w-full bg-amber-100 text-gray-600 text-xl hover:bg-yellow-200 border
