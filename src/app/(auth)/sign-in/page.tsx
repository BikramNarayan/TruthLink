...
function SignIn() {
  ...
  return (
    <div>
      {/* <NavBar/> */}
      <div className="flex justify-center items-center flex-col bg-amber-50 h-full lg:flex-row lg:px-40 px-10 min-h-screen">
        ...
        <div className="w-full">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div
                      ...
                      className="text-center cursor-pointer px-3 relative w-full"
                    >
              ...
              <Button
                type="submit"
                className="w-full bg-amber-200 text-gray-600 text-xl hover:bg-yellow-200"
              >
                {isLoading ? (
                  <>
          ...
          <div className="mt-4">
            ...
            <Link href="sign-up">
             ...
             border-darker-turquoise  bg-amber-100 text-gray-600 text-xl  hover:bg-yellow-200"
              >
                Create account
              </Button>
            </Link>
